    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 text-white">
        <section className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-wider mb-4 text-white">THIS IS ME</h1>
          <h2 className="text-2xl tracking-wide mb-6 text-white">R E G I N A</h2>
        ...
        <section className="mb-16 max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-white">MY STORY</h2>
          ...
          <ul className="space-y-4">
            {funFacts.map((fact, index) => (
              <li key={index} className="flex items-start space-x-4">
                <span className="font-bold text-xl min-w-[24px] text-white">{index + 1}.</span>
                <span className="text-lg text-gray-300">{fact}</span>
              </li>
            ))}
          </ul>
        </section>
