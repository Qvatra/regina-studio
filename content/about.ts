export const aboutContent = {
  ...
  ua: {
    ...
    metaDescription: "Дізнайтеся про історію Регіни, її шлях у фотографії та відеозйомці, та її пристрасть до візуальної розповіді.",
    heading: "МОЯ ІСТОРІЯ",
    bio: [
      "Мій шлях у світ візуального мистецтва розпочався у 2006 році, коли у 18 років я вперше взяла до рук камеру. Те, що починалося як захоплення, швидко перетворилося на справжню пристрасть, яка стала моєю професією.",
      "Народившись у Сибіру та проживши частину життя в Україні перед тим, як знайти свій дім у Нідерландах, я привношу багатий мультикультурний досвід у свою роботу. Володіння англійською, нідерландською, російською та українською мовами допомагає мені знаходити спільну мову з клієнтами з різних культур, створюючи невимушену атмосферу під час зйомок.",
      "Мій шлях не був прямим – я отримала ступінь бакалавра права і навіть працювала шеф-кухарем в італійському ресторані – але саме цей різноманітний досвід збагатив моє бачення та підхід до творчості. Кожен етап мого життя зробив свій внесок у те, як я розповідаю історії через об'єктив.",
