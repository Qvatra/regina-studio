...
export const servicesContent = {
  en: {
    title: "Services & Pricing | Studio Regina",
    metaDescription: "Prices for professional photography and videography services including weddings, events, portraits, commercial projects, and more.",
    heading: "SERVICES & PRICING",
    intro: "Professional photography and videography services tailored to your needs. Contact me for custom packages and special requirements.",
    services: [
      {
        title: "Photography",
  ...
  nl: {
    title: "Diensten & Prijzen | Studio Regina",
    metaDescription: "Prijzen voor professionele fotografie en videografie diensten, waaronder bruiloften, evenementen, portretten, commerciële projecten en meer.",
    heading: "DIENSTEN & PRIJZEN",
    intro: "Professionele fotografie- en videografiediensten op maat. Neem contact met mij op voor aangepaste pakketten en speciale wensen.",
    services: [
      {
        title: "Fotografie",
        path: "/nl/services/photography",
  ...
  ru: {
    title: "Услуги и Цены | Studio Regina",
    metaDescription: "Цены на профессиональные услуги фотографии и видеосъёмки, включая свадьбы, мероприятия, портреты, коммерческие проекты и многое другое.",
    heading: "УСЛУГИ И ЦЕНЫ",
    intro: "Профессиональные услуги фотографии и видеосъёмки, адаптированные под ваши потребности. Свяжитесь со мной для индивидуальных пакетов и особых требований.",
    services: [
      {
        title: "Фотография",
        path: "/ru/services/photography",
  ...
  ua: {
    title: "Послуги та Ціни | Studio Regina",
    metaDescription: "Ціни на професійні послуги фотографії та відеозйомки, включаючи весілля, заходи, портрети, комерційні проекти та багато іншого.",
    heading: "ПОСЛУГИ ТА ЦІНИ",
    intro: "Професійні послуги фотографії та відеозйомки, адаптовані під ваші потреби. Зв'яжіться зі мною для індивідуальних пакетів та особливих вимог.",
    services: [
      {
        title: "Фотографія",
        path: "/ua/services/photography",
