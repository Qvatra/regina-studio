export const photographyServicesContent = {
  ...
  ru: {
    ...
    packages: [
      {
        title: "Минимальный",
        description: "Идеально для портретов, личного бренда или небольших проектов",
        price: "€200",
        features: [
          "1 час съёмки",
      ...
      {
        title: "Базовый",
        description: "Отлично подходит для семейных съёмок, мероприятий или предметной фотографии",
        price: "€350",
        features: [
          "2 часа съёмки",
  ...
  ua: {
    ...
    imageAlt: "Професійна Фотографія в Амстердамі",
    packages: [
      {
        title: "Мінімальний",
        description: "Ідеально для портретів, особистого бренду або невеликих проектів",
        price: "€200",
        features: [
          "1 година зйомки",
          "25 оброблених фото"
      ...
      {
        title: "Базовий",
        description: "Чудово підходить для сімейних зйомок, заходів або предметної фотографії",
        price: "€350",
        features: [
          "2 години зйомки",
          "50 оброблених фото"
      ...
      {
        title: "Розширений",
        description: "Ідеально для великих заходів, комерційних проектів або масштабних зйомок",
        price: "€600",
        features: [
          "4 години зйомки",
          "100 оброблених фото"
    ...
    additionalFees: {
      ...
      confidentialityFee: {
        ...
        text: "Доплата у розмірі €50 застосовується, якщо ви не хочете, щоб фотографії використовувались у моєму портфоліо. Це забезпечує вашу повну конфіденційність, дозволяючи мені підтримувати справедливу цінову структуру."
      }
    },
    customPackage: {
